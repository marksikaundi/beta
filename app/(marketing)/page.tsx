        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
              Master backend development through hands-on projects and structured learning paths.
              Build real-world applications while learning Python, Go, SQL, and more.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-6 text-lg text-gray-600">
                Our comprehensive curriculum is designed by industry experts to help you
                master the skills that matter most in backend development.
              </p>
