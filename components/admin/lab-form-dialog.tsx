...
# array_sum([1, 2, 3, 4, 5]) # Should return 15`
      ...
      newData = {
        ...
        problemStatement: "Write a function that checks if a given string is a palindrome. A palindrome is a word, phrase, number, or other sequence of characters that reads the same forward and backward (ignoring spaces, punctuation, and capitalization).",
        examples: [
          { 
            input: '"racecar"', 
            output: "true", 
...
# is_palindrome("hello") # Should return False`
  ...
  const commonTags = [
    "Array", "String", "Math", "Dynamic Programming", "Graph", 
    "Tree", "Hash Table", "Binary Search", "Two Pointers", "Recursion",
    "Linked List", "Stack", "Queue", "Heap", "Sorting", "Greedy"
  ];

  // Common categories
  const commonCategories = [
    "Algorithms", "Data Structures", "Patterns", "JavaScript Fundamentals", 
    "Python Fundamentals", "Web Development", "Database", "System Design",
    "Object-Oriented Programming", "Frontend", "Backend", "Full-Stack"
  ];
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {mode === "create" && (
            <div className="bg-muted/50 border rounded-lg p-4 mb-4">
              <h4 className="text-sm font-medium mb-2">Quick Start with Templates</h4>
          ...
          <div>
            ...
            <div>
              ...
              {formData.testCases.map((testCase, index) => (
                <div key={index} className="space-y-2 mt-3 p-3 border rounded-md bg-muted/30">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    <div>
                      <Label htmlFor={`test-input-${index}`} className="text-xs">Input</Label>
                      <Textarea
                        id={`test-input-${index}`}
                        placeholder="Input"
                    ...
                    <div>
                      <Label htmlFor={`test-output-${index}`} className="text-xs">Expected Output</Label>
                      <Textarea
                  ...
                  <div>
                    <Label htmlFor={`test-description-${index}`} className="text-xs">Description</Label>
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          testCases: formData.testCases.map((tc, i) =>
                            i === index ? { ...tc, description: e.target.value } : tc
                          ),
                        })
                      }
                    />
            ...
            <div>
              ...
              <div className="mt-2">
                <p className="text-sm text-muted-foreground mb-1">Common categories:</p>
                <div className="flex flex-wrap gap-1">
                  {commonCategories.map((category) => (
                    <button
                      key={category}
          ...
          <div className="border-t pt-6 mt-6">
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="javascriptCode">JavaScript Starter Code</Label>
                <Textarea
                  id="javascriptCode"
                  value={formData.starterCode.javascript}
                  onChange={(e) =>
              ...
              <div>
                <Label htmlFor="pythonCode">Python Starter Code</Label>
                <Textarea
                  id="pythonCode"
                  value={formData.starterCode.python}
                  onChange={(e) =>
