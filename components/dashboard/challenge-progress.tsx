...
export function ChallengeProgress() {
  ...
  if (!userStats || !recommendedChallenges) {
    return (
      <Card className="modern-card">
        <CardHeader>
          ...
          <CardDescription>Track your coding challenge progress</CardDescription>
        </CardHeader>
        <CardContent>
    ...
    <Card className="modern-card">
      <CardHeader>
        <div className="flex justify-between items-start">
          <div>
            ...
            <CardDescription>Your progress on coding challenges</CardDescription>
          </div>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pb-4 border-b">
          ...
          <div className="text-center p-2">
            <p className="text-2xl font-bold text-green-500">{userStats.byDifficulty?.Easy || 0}</p>
            <p className="text-xs text-muted-foreground">Easy</p>
          </div>
          <div className="text-center p-2">
            <p className="text-2xl font-bold text-yellow-500">{userStats.byDifficulty?.Medium || 0}</p>
          ...
          <div className="space-y-4">
            ...
            {Object.entries(userStats.byCategory).map(([category, count]) => (
              <div key={category} className="space-y-1">
                ...
                <Progress value={Math.min(count as number * 10, 100)} className="h-2" />
              </div>
            ))}
          </div>
        )}
